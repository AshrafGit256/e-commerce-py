...
class Category(models.Model):
    cid = models.ShortUUIDField(unique=True, length=10, max_length=30, prefix="cat", alphabet="abcdefgh12345")
    ...
    class Vendor(models.Model):
        vid = models.ShortUUIDField(unique=True, length=10, max_length=30, prefix="ven", alphabet="abcdefgh12345")
    ...
    class Product(models.Model):
        pid = models.ShortUUIDField(unique=True, length=10, max_length=30, alphabet="abcdefgh12345")
